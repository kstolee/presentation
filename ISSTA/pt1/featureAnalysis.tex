...
\item [] \begin{footnotesize}114 had various errors\end{footnotesize}
...
\item<2-> But regex feature usage references were missing.
\item <3-> So, 
\end{itemize}

\onslide<4->{
\begin{block}{}%{\begin{Large}Regex Feature Usage References Are Missing\end{Large}}
\begin{large}How well do regex research tools meet the needs of developers? (Hampi, Rex, RE2, brics)\end{large}
%\begin{itemize}
%\item \begin{large}feature usage statistics\end{large}
%\item \begin{large}feature set summaries for variants and tools\end{large}
%\end{itemize}
...
\begin{block}{}
\begin{itemize}
	\item Regexes are common, but not everywhere (42\% of projects)
