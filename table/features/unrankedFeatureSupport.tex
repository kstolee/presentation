...
\begin{tabular}{l@{  }lc @{   } c @{   }c @{   }c @{   }c @{   }c @{   }c @{   }c} \\
\textbf{Code} & \textbf{Example} & \textbf{Python} & \textbf{Perl} & \textbf{.Net}  & \textbf{Ruby} &  \textbf{Java} & \textbf{RE2} & \textbf{JavaScript} &\textbf{POSIX ERE}\\
\toprule
