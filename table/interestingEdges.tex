...
\noalign{\hrule height 0.08em}
T4 & \begin{minipage}{0.92in}\begin{footnotesize}\cverb!xyz[\0133-\0140]!\end{footnotesize}\end{minipage} & 71\% & 33\% & $\overrightarrow{T4 T2}$ & T2 & \begin{minipage}{1.0in}\cverb!xyz[\x5b-\x5f]!\end{minipage} & 79\% & 60\%     \\
T4 & \begin{minipage}{0.92in}\cverb!t[\072-\073]+p!\end{minipage} & 90\% & 70\% &  & T2 & \begin{minipage}{1.0in}\cverb!t[\x3a-\x3b]+p!\end{minipage} & 89\% & 70\%     \\
\noalign{\hrule height 0.08em}
\end{tabular}
\end{adjustbox}
